...
public class YoutubeRestController {
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "videoId", value = "디테일로 들어갈 때 필요한 videoId", dataTypeClass = String.class, required = true)
	})
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "videoId", value = "어떤 video의 댓글을 조회 할지 필요함", dataTypeClass = String.class, required = true)
	})
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "youtubeComm", value = "video_id,user_id,comm,class_no,comm_group", dataTypeClass = YoutubeComm.class, required = true)
	})
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "youtubeComm", value = "별 다른 정보가 필요하진 않고.. commIndex필요 할듯?", dataTypeClass = YoutubeComm.class, required = true)
	})
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "youtubeComm", value = "바뀔 내용 comm과 commIndex 필요", dataTypeClass = YoutubeComm.class, required = true)
	})
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "YoutubeLiked", value = "userId와 videoId 필요", dataTypeClass = YoutubeLiked.class, required = true)
	})
